...
#random values to pick from 0.25, 0.5, 1.0
...
for sample in samples:
  ...
  #looks up the option to choose ...
  time.sleep(timeIntervals[randomIndex]) #makes integers of the randm object
  print(timeIntervals[randomIndex])
