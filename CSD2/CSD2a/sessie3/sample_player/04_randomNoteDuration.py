...
- Answer the following questions before running the code:
  ...
  - How many times a sample will be played? er zijn 3 samples die allemaal 4 keer afspelen (dus 12 samples totaal)(want, for i in range(4))
  - How many seconds will there be in between the playback of samples? er wordt random bepaalt of er 0.25, 0.5 or 1 seconde tussen zit/of wordt helemaal random bepaald????
