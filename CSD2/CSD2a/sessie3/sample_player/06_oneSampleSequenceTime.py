...
- Run the code, read the code and answer the following question:
  - This script transforms a list of 'sixteenth notes timestamps' into a list of
    ...
    in de andere opdracht wordt gebruik gemaakt van time.sleep()
    deze is minder accuraat omdat het kan zijn dat de processor druk bezig is met andere dingen en daardoor de sleep niet altijd op tijd kan uitvoeren.
